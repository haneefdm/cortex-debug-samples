...
# Following code is needed if you want to run 'init'. You cannot change the
# gdb_port after init. Aso, since init is automatically by OpenOCD, we do not
# need to run it here
if {0} {
    ...
    if { $ENABLE_CM0 != 0 } {
        ...
        puts "Haneef: Enable real port for debugging CM4: backup ${our_preferred_gdb_port} port by 1"
    }
